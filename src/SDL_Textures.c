...
void SDL_GenerateTilemap()
{
    ...
    SDL_Surface *tiles[MAX_TILES];  //16 tile surfaces
    ...
    {
        tiles[i] = SDL_CreateRGBSurface(SDL_HWSURFACE | SDL_SRCCOLORKEY, TILE_WIDTH, TILE_HEIGHT, 32, rmask, gmask, bmask, amask);   //Luodaan tyhjä taso
    }

    for(y = 0; y < TILEMAP_HEIGTH; y++)
    {
